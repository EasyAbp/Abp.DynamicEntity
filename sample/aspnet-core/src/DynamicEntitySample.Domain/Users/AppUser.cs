...
namespace DynamicEntitySample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DynamicEntitySampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DynamicEntitySampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
