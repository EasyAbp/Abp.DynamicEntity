...
{
    public static class DynamicEntitySampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE DynamicEntitySampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
