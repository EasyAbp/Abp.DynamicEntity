...
namespace DynamicSample.ObjectExtending
{
    public static class DynamicSampleDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the DynamicSampleEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
