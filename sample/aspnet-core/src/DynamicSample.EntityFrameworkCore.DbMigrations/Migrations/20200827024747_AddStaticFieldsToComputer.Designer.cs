...
namespace DynamicSample.Migrations
{
    ...
    [Migration("20200827024747_AddStaticFieldsToComputer")]
    partial class AddStaticFieldsToComputer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DynamicSample.Computers.Computer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppComputers");
                });

            modelBuilder.Entity("EasyAbp.Abp.Dynamic.FieldDefinitions.FieldDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EasyAbp.Abp.Dynamic.ModelDefinitions.ModelDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DynamicModelDefinitions");
                });

            modelBuilder.Entity("EasyAbp.Abp.Dynamic.ModelDefinitions.ModelField", b =>
                {
                    ...
                    b.HasKey("FieldDefinitionId", "ModelDefinitionId");

                    b.HasIndex("ModelDefinitionId");

                    b.ToTable("DynamicModelFields");
                });
            ...
            modelBuilder.Entity("DynamicSample.Computers.Computer", b =>
                {
                    b.HasOne("EasyAbp.Abp.Dynamic.ModelDefinitions.ModelDefinition", "ModelDefinition")
                        .WithMany()
            ...
            modelBuilder.Entity("EasyAbp.Abp.Dynamic.ModelDefinitions.ModelField", b =>
                {
                    b.HasOne("EasyAbp.Abp.Dynamic.ModelDefinitions.ModelDefinition", null)
                        .WithMany("Fields")
                        .HasForeignKey("ModelDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
