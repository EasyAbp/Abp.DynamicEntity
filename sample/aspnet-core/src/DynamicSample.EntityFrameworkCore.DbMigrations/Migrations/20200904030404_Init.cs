    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicModelDefinitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    TenantId = table.Column<Guid>(nullable: true),
                    ModelDefinitionId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicDynamicEntities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DynamicDynamicEntities_DynamicModelDefinitions_ModelDefinitionId",
            ...
            migrationBuilder.CreateTable(
                name: "DynamicModelFields",
                columns: table => new
                {
                    ModelDefinitionId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicModelFields", x => new { x.FieldDefinitionId, x.ModelDefinitionId });
                    table.ForeignKey(
                        name: "FK_DynamicModelFields_DynamicFieldDefinitions_FieldDefinitionId",
                        column: x => x.FieldDefinitionId,
                        principalTable: "DynamicFieldDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DynamicModelFields_DynamicModelDefinitions_ModelDefinitionId",
                        column: x => x.ModelDefinitionId,
                        principalTable: "DynamicModelDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
