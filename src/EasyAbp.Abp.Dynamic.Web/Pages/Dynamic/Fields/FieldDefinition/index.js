$(function () {
    ...
    var service = easyAbp.abp.dynamic.fields.fieldDefinition;
    var createModal = new abp.ModalManager(abp.appPath + 'Dynamic/Fields/FieldDefinition/CreateModal');
    var editModal = new abp.ModalManager(abp.appPath + 'Dynamic/Fields/FieldDefinition/EditModal');
